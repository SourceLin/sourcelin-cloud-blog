...
import com.sourcelin.common.core.utils.SpringUtils;
import com.sourcelin.common.core.utils.StringUtils;
import com.sourcelin.common.core.utils.bean.BeanValidators;
import com.sourcelin.common.datascope.annotation.DataScope;
...
import com.sourcelin.system.domain.SysUserPost;
import com.sourcelin.system.domain.SysUserRole;
import com.sourcelin.system.mapper.SysPostMapper;
import com.sourcelin.system.mapper.SysRoleMapper;
import com.sourcelin.system.mapper.SysUserMapper;
import com.sourcelin.system.mapper.SysUserPostMapper;
import com.sourcelin.system.mapper.SysUserRoleMapper;
...
public class SysUserServiceImpl implements ISysUserService
{
    ...
    {
        if (!SysUser.isAdmin(adminLoginAccessor.getCurrentUserId()))
        {
     ...
     */
    @Override
    public boolean updateUserAvatar(String userName, String avatar, Long avatarFileId)
    {
        return userMapper.updateUserAvatarFileId(userName, avatar, avatarFileId) > 0;
    }
