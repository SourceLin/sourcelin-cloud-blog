...
const MenuIcon = defineComponent({
  props: { icon: String },
  setup(props) {
    const isElIcon = computed(() => isElementPlusIconName(props.icon));
...
.el-sub-menu {
  ...
  &.has-active-child > .el-sub-menu__title {
    color: var(--menu-active-parent-text) !important;
    background-color: var(--menu-active-parent-bg) !important;
  ...
  html.dark & {
    &.has-active-child > .el-sub-menu__title {
      color: var(--menu-active-parent-text) !important;
      background-color: var(--menu-active-parent-bg-emphasis) !important;
