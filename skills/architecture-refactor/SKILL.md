...
- 对齐 `rules/`、`skills/`、`AGENTS.md`、`docs/architecture/**`。
...
1. 读取 `AGENTS.md`、`rules/README.md`、全部相关领域规则和 `docs/architecture/**`。
...
7. 对规则体系重构，同步更新 `rules/`、`skills/`、`AGENTS.md` 和规则守卫脚本。
8. 每个子模块完成后运行对应验证命令，失败先修复再进入下一模块。
