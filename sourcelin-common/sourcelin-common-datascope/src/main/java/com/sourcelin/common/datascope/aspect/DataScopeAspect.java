package com.sourcelin.common.datascope.aspect;
...
public class DataScopeAspect
{
    ...
    {
        SysLoginUser loginUser = resolveAdminLoginUser();
    ...
    private SysLoginUser resolveAdminLoginUser()
    {
        if (!StpAdminUtil.stpLogic.isLogin())
        {
            return null;
        }
        Object loginUser = StpAdminUtil.stpLogic.getSession().get("loginUser");
