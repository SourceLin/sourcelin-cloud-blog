package com.sourcelin.common.log.aspect;
...
import com.sourcelin.common.log.enums.BusinessStatus;
import com.sourcelin.common.log.filter.PropertyPreExcludeFilter;
import com.sourcelin.common.log.service.AsyncLogService;
...
public class LogAspect
{
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult)
    {
        try
        {
            ...
            String username = adminLoginAccessor.getUsername();
